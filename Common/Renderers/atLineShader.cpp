...
void atLineShader::DrawCoordinateAxes(Matrix4f& MVPMatrix)
{
	std::vector<Vector3f> verts(6, Vector3f(0, 0, 0));
	verts[1][0] = 5; //x - axis
	verts[3][1] = 5; //y - axis
	verts[5][2] = 5; //z - axis

	std::vector<Vector3f> colors(6, Vector3f(0, 0, 0));
	colors[0][0] = 1; //x - axis
	colors[1][0] = 1; //x - axis
	colors[2][1] = 1; //y - axis
	colors[3][1] = 1; //y - axis
